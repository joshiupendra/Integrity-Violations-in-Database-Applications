...
public class UIDDBInsertor 
{
    public void insert(ArrayList a)
    {
        try
        {
            ...
            String uid = (String) a.get(0);
            String name = (String) a.get(1);
            String dob = (String) a.get(2);
            String address = (String) a.get(3);
            String gender = (String) a.get(4);
            String mob_num = (String) a.get(5);
            String email = (String) a.get(6);
            String mname = (String) a.get(7);
            String fname = (String) a.get(8);
            
            
            //System.out.println(account_no+"\n"+cust_name+"\n"+dob+"\n"+address+"\n"+branch+"\n"+MICR+"\n"+IFSC+"\n"+mob_num+"\n"+email+"\n"+ balance+"\n"+ acc_type +"\n"+card_type +"\n"+card_num +"\n"+gender);
            String query = "Insert into uidInfo values('"+uid+"','"+name+"','"+dob+"','"+address+"','"+gender+"','"+mob_num+"','"+email+"','"+mname+"','"+fname+"')";
